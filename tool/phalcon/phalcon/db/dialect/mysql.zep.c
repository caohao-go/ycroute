...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, getColumnDefinition) {
	...
	do {
		...
		if (ZEPHIR_IS_EMPTY(&columnSql)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_20$$49, "__construct", NULL, 1, &_22$$49);
			zephir_check_call_status();
		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _23$$51)
				{
					...
					ZVAL_STRING(&_24$$52, "\"");
					ZEPHIR_CALL_FUNCTION(&_25$$52, "addcslashes", &_26, 34, &value$$51, &_24$$52);
					zephir_check_call_status();
				...
				ZVAL_STRING(&_32$$53, "\"");
				ZEPHIR_CALL_FUNCTION(&_33$$53, "addcslashes", &_26, 34, &typeValues, &_32$$53);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, addColumn) {
	...
	if (zephir_is_true(&_3)) {
		...
		if (zephir_memnstr_str(&_4$$3, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/mysql.zep", 229)) {
			...
			ZVAL_STRING(&_5$$5, "\"");
			ZEPHIR_CALL_FUNCTION(&_6$$5, "addcslashes", NULL, 34, &defaultValue, &_5$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, addIndex) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "getcolumnlist", NULL, 23, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_5);
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, addPrimaryKey) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getcolumnlist", NULL, 23, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, addForeignKey) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "getcolumnlist", NULL, 23, &_3);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "getcolumnlist", NULL, 23, &_8);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&sql);
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, createTable) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _0)
	{
		...
		if (zephir_is_true(&_4$$7)) {
			...
			if (zephir_memnstr_str(&_5$$8, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/mysql.zep", 414)) {
				...
				ZVAL_STRING(&_6$$10, "\"");
				ZEPHIR_CALL_FUNCTION(&_7$$10, "addcslashes", &_8, 34, &defaultValue, &_6$$10);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&indexes, &definition, SL("indexes"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _13$$14)
		{
			...
			if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_14$$16, this_ptr, "getcolumnlist", &_16, 23, &_15$$16);
				zephir_check_call_status();
				...
				if (!(ZEPHIR_IS_EMPTY(&indexType))) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_17$$18, this_ptr, "getcolumnlist", &_16, 23, &_18$$18);
					zephir_check_call_status();
					ZEPHIR_CONCAT_VSVSVS(&indexSql, &indexType, " KEY `", &indexName, "` (", &_17$$18, ")");
				} else {
					ZEPHIR_CALL_METHOD(&_20$$19, &index, "getcolumns", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_19$$19, this_ptr, "getcolumnlist", &_16, 23, &_20$$19);
					zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _21$$20)
		{
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_23$$21, this_ptr, "getcolumnlist", &_16, 23, &_24$$21);
			zephir_check_call_status();
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_26$$21, this_ptr, "getcolumnlist", &_16, 23, &_27$$21);
			zephir_check_call_status();
