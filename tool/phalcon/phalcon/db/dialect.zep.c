...
PHP_METHOD(Phalcon_Db_Dialect, getColumnList) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columnList), _0)
	{
		...
		ZVAL_COPY(&column, _0);
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "getsqlcolumn", &_2, 9, &column, &escapeChar, bindCounts);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpression) {
	...
	do {
		if (ZEPHIR_IS_STRING(&type, "scalar")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionscalar", NULL, 10, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "object")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionobject", NULL, 11, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "qualified")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionqualified", NULL, 12, &expression, &escapeChar);
			zephir_check_call_status();
			RETURN_MM();
		}
		...
		if (ZEPHIR_IS_STRING(&type, "binary-op")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionbinaryoperations", NULL, 13, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "unary-op")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionunaryoperations", NULL, 14, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "parentheses")) {
			...
			ZEPHIR_CALL_METHOD(&_7$$14, this_ptr, "getsqlexpression", NULL, 15, &_8$$14, &escapeChar, bindCounts);
			zephir_check_call_status();
			ZEPHIR_CONCAT_SVS(return_value, "(", &_7$$14, ")");
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "functionCall")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionfunctioncall", NULL, 16, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "list")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionlist", NULL, 17, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "all")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionall", NULL, 18, &expression, &escapeChar);
			zephir_check_call_status();
			RETURN_MM();
		}
		...
		if (ZEPHIR_IS_STRING(&type, "cast")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressioncastvalue", NULL, 19, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "convert")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionconvertvalue", NULL, 20, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "case")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressioncase", NULL, 21, &expression, &escapeChar, bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
	} while(0);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlTable) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 22, table, &escapeChar);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Db_Dialect, select) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getcolumnlist", NULL, 23, &columns, &escapeChar, &bindCounts);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZEPHIR_CONCAT_SV(&_1, " ", &_0);
	zephir_concat_self(&sql, &_1 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "getsqlexpressionfrom", NULL, 24, &tables, &escapeChar);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
	...
	if (_4) {
		...
		ZEPHIR_CALL_METHOD(&_5$$9, this_ptr, "getsqlexpressionjoins", NULL, 25, &_6$$9, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_8) {
		ZEPHIR_CALL_METHOD(&_9$$10, this_ptr, "getsqlexpressionwhere", NULL, 26, &where, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_11) {
		ZEPHIR_CALL_METHOD(&_12$$11, this_ptr, "getsqlexpressiongroupby", NULL, 27, &groupBy, &escapeChar);
		zephir_check_call_status();
	...
	if (_14) {
		ZEPHIR_CALL_METHOD(&_15$$12, this_ptr, "getsqlexpressionhaving", NULL, 28, &having, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_17) {
		ZEPHIR_CALL_METHOD(&_18$$13, this_ptr, "getsqlexpressionorderby", NULL, 29, &orderBy, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_20) {
		...
		ZEPHIR_CALL_METHOD(&sql, this_ptr, "getsqlexpressionlimit", NULL, 30, &_21$$14, &escapeChar, &bindCounts);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionScalar) {
	...
	if (zephir_array_isset_string(&expression, SL("column"))) {
		...
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlcolumn", NULL, 9, &_0$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_OBS_VAR(&value);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionBinaryOperations) {
	...
	ZEPHIR_CALL_METHOD(&right, this_ptr, "getsqlexpression", NULL, 15, &_1, &escapeChar, bindCounts);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionUnaryOperations) {
	...
	if (zephir_array_isset_string_fetch(&right, &expression, SL("right"), 0)) {
		...
		ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "getsqlexpression", NULL, 15, &right, &escapeChar, bindCounts);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionCase) {
	...
	zephir_is_iterable(&_2, 0, "phalcon/db/dialect.zep", 752);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_2), _3)
	{
		ZEPHIR_INIT_NVAR(&whenClause);
		ZVAL_COPY(&whenClause, _3);
		zephir_array_fetch_string(&_4$$3, &whenClause, SL("type"), PH_NOISY | PH_READONLY, "phalcon/db/dialect.zep", 742 TSRMLS_CC);
		if (ZEPHIR_IS_STRING(&_4$$3, "when")) {
			zephir_array_fetch_string(&_6$$4, &whenClause, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/db/dialect.zep", 744 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "getsqlexpression", NULL, 15, &_6$$4, &escapeChar, bindCounts);
			zephir_check_call_status();
			zephir_array_fetch_string(&_8$$4, &whenClause, SL("then"), PH_NOISY | PH_READONLY, "phalcon/db/dialect.zep", 746 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_7$$4, this_ptr, "getsqlexpression", NULL, 15, &_8$$4, &escapeChar, bindCounts);
			zephir_check_call_status();
			ZEPHIR_INIT_LNVAR(_9$$4);
			ZEPHIR_CONCAT_SVSV(&_9$$4, " WHEN ", &_5$$4, " THEN ", &_7$$4);
			zephir_concat_self(&sql, &_9$$4 TSRMLS_CC);
		} else {
			zephir_array_fetch_string(&_11$$5, &whenClause, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/db/dialect.zep", 748 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_10$$5, this_ptr, "getsqlexpression", NULL, 15, &_11$$5, &escapeChar, bindCounts);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionFrom) {
	...
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0$$3)
		{
			...
			ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "getsqltable", &_2, 31, &table, &escapeChar);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionJoins) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0)
	{
		...
		if (_1$$3) {
			if (!(zephir_array_isset_long(&joinConditionsArray, 0))) {
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&joinConditionsArray), _3$$6)
				{
					...
					ZEPHIR_CALL_METHOD(&_4$$7, this_ptr, "getsqlexpression", &_2, 15, &condition, &escapeChar, bindCounts);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&joinTable, this_ptr, "getsqltable", &_8, 31, &_7$$3, &escapeChar);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionLimit) {
	...
	if (Z_TYPE_P(&value) == IS_ARRAY) {
		...
		if (_2$$4) {
			ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "getsqlexpression", NULL, 15, &offset, &escapeChar, bindCounts);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareColumnAlias) {
	...
	if (!ZEPHIR_IS_STRING(&alias, "")) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "escape", NULL, 22, &alias, &escapeChar);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareTable) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "escape", NULL, 22, &table, &escapeChar);
	zephir_check_call_status();
	zephir_get_strval(&table, &_0);
	if (!ZEPHIR_IS_STRING(&schema, "")) {
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "escapeschema", NULL, 32, &schema, &escapeChar);
		zephir_check_call_status();
	...
	if (!ZEPHIR_IS_STRING(&alias, "")) {
		ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "escape", NULL, 22, &alias, &escapeChar);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareQualified) {
	...
	if (!ZEPHIR_IS_STRING(&domain, "")) {
		...
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 22, &_0$$3, &escapeChar);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 22, &column, &escapeChar);
	zephir_check_call_status();
	RETURN_MM();
