...
PHP_METHOD(Phalcon_Db_Adapter, insert) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval values;
	zval *table, table_sub, *values_param = NULL, *fields = NULL, fields_sub, *dataTypes = NULL, dataTypes_sub, __$null, placeholders, insertValues, bindDataTypes, bindType, position, value, escapedTable, joinedValues, escapedFields, field, insertSql, *_2, _0$$3, _1$$3, _6$$7, _7$$8, *_8$$11, _10$$11, _9$$12;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(fields) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(fields), _8$$11)
		{
			...
			zephir_check_call_status();
			zephir_array_append(&escapedFields, &_9$$12, PH_SEPARATE, "phalcon/db/adapter.zep", 358);
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&field);
...
PHP_METHOD(Phalcon_Db_Adapter, describeIndexes) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&indexes), _7, _8, _6)
	{
		...
		ZEPHIR_CALL_METHOD(NULL, &_9$$6, "__construct", &_10, 2, &name, &indexColumns);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter, describeReferences) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&references), _13, _14, _12)
	{
		...
		ZEPHIR_CALL_METHOD(NULL, &_15$$6, "__construct", &_18, 3, &name, &_16$$6);
		zephir_check_call_status();
