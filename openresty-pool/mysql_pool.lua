...
local function parse_request(sock)
	...
	--ngx.log(ngx.ERR, "parse_request sql_size=[", sql_size, "]")
    ...
    --ngx.log(ngx.ERR, "parse_request sql_str=[", sql_str, "]")
	...
	--ngx.log(ngx.ERR, "parse_request map_size=[", map_size, "]")
    ...
    --ngx.log(ngx.ERR, "parse_request map_res=[", map_res, "]")
...
local function response_error(sock, errno, errmsg, sqlstate)
	...
	--ngx.log(ngx.ERR, "response_error send_str=[", send_str, "]")
